    ...
    <x-filament::section>
        ...
        <div class="space-y-3">
            ...
            <x-filament::modal id="confirm-reset-{{ $item->id }}" width="md">
                <x-slot name="heading">
                    Konfirmasi Reset Stok
                </x-slot>

                <div class="space-y-4">
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-4">
                        <p class="font-semibold text-yellow-900 dark:text-yellow-100">⚠️ Peringatan</p>
                        <p class="text-sm text-yellow-800 dark:text-yellow-200 mt-1">
                            Anda akan membuang sisa stok <strong>{{ $item->name }}</strong> sebanyak
                            <strong>{{ number_format($item->prepared_stock, 2) }} {{ $unit }}</strong>.
                        </p>
                    </div>

                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        <p>⚠️ Stok akan direset ke <strong>0</strong></p>
                        <p>⚠️ Bahan baku <strong>TIDAK</strong> akan dikembalikan</p>
                        <p>⚠️ Aksi ini <strong>TIDAK BISA</strong> dibatalkan</p>
                    </div>
