        ...
        <div
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative" x-data="{ showFallback: false }">
                            ...
                            <div @class([ 'absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white dark:border-gray-800' , 'bg-green-500'=> $status === 'connected',
            ...
            <div class="hidden md:flex flex-1 flex-col h-full bg-[#efeae2] dark:bg-[#0b141a] relative" x-data="{ 
                                ...
                                <div
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <button wire:click="downloadMedia({{ $msg->id }})" wire:loading.attr="disabled"
                                            ...
                                            <span wire:loading.remove wire:target="downloadMedia({{ $msg->id }})">Unduh
                                                Sekarang</span>
                ...
                <div
                    ...
                    <h2 class="text-2xl font-light text-gray-700 dark:text-gray-200 mb-2">WhatsApp Web for Resto POS
                    </h2>
