        ...
        <div x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex-shrink-0 mr-3">
                <template x-if="note.type === 'success'">
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-full flex items-center justify-center shadow-inner">
                ...
                <template x-if="note.type === 'error'">
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-rose-100 to-rose-200 rounded-full flex items-center justify-center shadow-inner">
                ...
                <template x-if="note.type === 'info'">
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center shadow-inner">
                ...
                <template x-if="note.type === 'warning'">
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-amber-100 to-amber-200 rounded-full flex items-center justify-center shadow-inner">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-black leading-tight tracking-tight"
                    x-text="note.type.charAt(0).toUpperCase() + note.type.slice(1)"></p>
                <p class="text-xs font-medium mt-0.5 opacity-90 truncate leading-relaxed" x-text="note.message"></p>
            </div>

            {{-- Close Button --}}
            <button @click="remove(note.id)"
                class="ml-2 w-6 h-6 flex items-center justify-center rounded-full hover:bg-black/5 text-slate-400 hover:text-slate-600 transition">
