<div class="bg-gray-50 min-h-screen pb-48 font-sans">
    ...
    <div class="px-5 py-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex gap-4 bg-white p-4 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100/50 relative overflow-hidden group">
                ...
                <div class="flex-1 flex flex-col justify-between py-1">
                    <div>
                        <h3 class="font-bold text-gray-900 text-base leading-snug line-clamp-1 mb-1">{{ $item['name'] }}</h3>
        ...
        <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-5 pb-20 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-40 backdrop-blur-xl bg-white/90">
            <div class="space-y-1 mb-8">
                ...
                <div class="flex justify-between items-center pt-2 mt-1">
                    ...
                    <span class="text-2xl font-extrabold text-primary-600">Rp {{ number_format($total, 0, ',', '.') }}</span>
                </div>
                <a href="{{ route('order.checkout') }}" wire:navigate class="block w-full bg-primary-600 text-white text-center py-4 rounded-2xl font-bold text-lg shadow-lg shadow-primary-500/30 hover:bg-primary-700 hover:shadow-xl active:scale-95 transition-all duration-200">
                    Lanjut ke Pemesanan
                </a>

                <a href="{{ route('order.menu') }}" wire:navigate class="block text-center text-gray-400 font-medium text-xs mt-4 hover:text-gray-600 transition">
                    Tambah Menu Lain
                </a>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-center py-20 min-h-[60vh]">
            ...
            <a href="{{ route('order.menu') }}" wire:navigate class="inline-flex items-center gap-2 bg-primary-600 text-white px-8 py-3.5 rounded-full font-bold text-sm shadow-lg shadow-primary-500/30 hover:bg-primary-700 hover:scale-105 transition-all duration-300">
