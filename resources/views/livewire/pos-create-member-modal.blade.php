        ...
        <div class="fixed inset-0 z-[100] flex items-center justify-center p-4" x-data
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-lg font-bold relative z-10">{{ __('messages.member_new_title') }}</h2>
                    <p class="text-xs text-indigo-100 relative z-10">{{ __('messages.member_new_desc') }}</p>
                </div>
                ...
                <div class="p-6 w-full space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">{{ __('messages.full_name') }}</label>
                        <input type="text" wire:model="name"
                            ...
                            placeholder="{{ __('messages.customer_name') }}" autofocus>
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">{{ __('messages.phone_whatsapp') }}</label>
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">{{ __('messages.email_optional') }}</label>
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <button wire:click="save" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove wire:target="save">{{ __('messages.save_member') }}</span>
