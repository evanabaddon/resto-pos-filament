<div class="hidden sm:block">
    <button id="cash-summary-btn" wire:click="openCashSummary" @class([
        'cursor-pointer flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200',
