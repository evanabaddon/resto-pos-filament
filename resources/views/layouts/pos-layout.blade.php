...
<body class="bg-slate-50 flex flex-col h-screen overflow-hidden antialiased text-slate-800">
    ...
    {{-- 🔝 TOP NAVBAR (Glass) --}}
    {{-- ========================= --}}
    <header class="flex-shrink-0 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-slate-200/60 px-6 py-3 shadow-sm z-30 relative">
        <div class="flex items-center space-x-3">
             <div class="h-9 w-9 bg-gradient-to-br from-violet-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-violet-200">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="hidden sm:block pl-3 border-l border-slate-200">
                ...
                class="group bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-900 px-4 py-2 rounded-xl text-sm font-bold cursor-pointer inline-flex items-center gap-2 transition-all active:scale-95">
